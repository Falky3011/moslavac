                    ...
                    <div key={news.id} className="h-[28rem] sm:h-[32rem] md:h-[36rem] lg:h-[40rem]">
                        <div className="relative h-full group">
                            <img
                                ...
                                alt={news.title}
                                className={`absolute inset-0 w-full h-full transition-transform duration-700 ease-in-out group-hover:scale-105 ${news.thumbnailPath ? 'object-cover' : 'object-contain'
                                    }`}
                            />
