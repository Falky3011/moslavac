...
export default function MatchInfo() {
    ...
    if (matchInfoError || !matchInfo || !matchEvents || !matchLineups || !matchReferees) {
        return (
    ...
    const { homeTeam, awayTeam, dateTimeUTC, round, competition, homeTeamResult, awayTeamResult } = matchInfo;
