...
export default function WebShop() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 rounded-3xl bg-gradient-to-br from-gray-50 to-white shadow-md transition-all duration-300 hover:shadow-xl">
