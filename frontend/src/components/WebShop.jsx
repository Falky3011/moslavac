...
export default function WebShop() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16 rounded-3xl bg-white shadow-md transition-all duration-300 hover:shadow-xl">
        ...
        >
          {items.map((item) => (
            <div key={item.id} className="px-2 sm:px-4 py-8">
              <div className="bg-white w-full max-w-[280px] h-[420px] mx-auto rounded-2xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105">
                <div className="relative w-full h-[280px] overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                    <Link
                      ...
                      className="bg-white text-gray-900 font-semibold py-2 px-4 rounded-full hover:bg-gray-100 transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
                    >
                      Detalji
                    </Link>
                  </div>
                ...
                <div className="p-4 text-center">
                  ...
                  <Link
                    to="https://alpashrvatska.hr/snk-moslavac-popovaca/"
                    className="w-full bg-blue-600 text-white font-semibold py-2 px-4 rounded-lg hover:bg-blue-700 transition duration-300 ease-in-out transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center justify-center"
                  >
