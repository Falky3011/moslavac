...
export default function CustomFooter() {
  ...
  const handleNotificationSubscribe = async () => {
    if (!("Notification" in window)) {
      notification.error({
        message: "Vaš preglednik ne podržava notifikacije.",
      });
      return;
    }
      ...
      try {
        ...
        if (permission === "granted") {
          notification.success({
            message: "Uspješno ste uključili notifikacije!",
          });
        ...
        notification.error({
          message: "Greška pri uključivanju notifikacija.",
        });
      }
    }
  };
    ...
    <div className="transition-all duration-300 ease-in-out hover:translate-y-[-5px]">
      ...
      <ul className="space-y-4">
        <li className="flex items-center">
          ...
          <a
            href="mailto:snkmoslavac@gmail.com"
  ...
  const AboutUs = () => (
    <div className="transition-all duration-300 ease-in-out hover:translate-y-[-5px]">
      ...
      <Text>
        SNK Moslavac je sportski klub posvećen promicanju atletike, timskog rada
        i zajedništva. Osnovan 1933. godine, imamo bogatu povijest njegovanja
        talenata i ljubavi prema sportu u Popovači i šire.
      </Text>
    </div>
  );
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col items-center mb-16 space-y-8">
          ...
          <div className="text-center">
            <Title
              level={2}
              className="mb-3 font-serif italic tracking-wide"
              style={{ color: "#1890ff" }}
            >
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <Text className="text-center md:text-left text-sm">
              &copy; {new Date().getFullYear()} SNK Moslavac. Sva prava
              pridržana. Dizajn i razvoj web stranice: Adriano Faletar
            </Text>
