...
export default function FootballClubYouTubePromo() {
    ...
    return (
        <div className="bg-white rounded-3xl shadow-md p-6 sm:p-8 my-12 relative overflow-hidden max-w-7xl mx-auto">
            <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between">
                <div className="mb-8 lg:mb-0 lg:mr-8 flex-1">
                    ...
                    <p className="text-base sm:text-lg mb-6 leading-relaxed text-gray-700">
                        Ne propustite nijednu utakmicu! Pretplatite se na naš YouTube kanal za prijenose uživo,
                        najbolje trenutke i ekskluzivni sadržaj.
                    </p>
                    <Button
                        type="primary"
                ...
                <div className="w-full lg:w-auto">
                    <div className="flex flex-col items-center p-4 bg-gray-100 rounded-2xl">
                        <div className="text-3xl text-blue-500 mb-2">{subscriberStat.icon}</div>
                        <div className="text-sm text-gray-600 text-center">{subscriberStat.label}</div>
                        <div className="text-lg font-semibold text-gray-800">{subscriberStat.value}</div>
                    </div>
                </div>
            </div>
        </div>
