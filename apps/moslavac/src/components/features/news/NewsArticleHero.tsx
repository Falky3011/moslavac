    ...
    <header className="dark relative isolate -mt-20 flex min-h-[68svh] w-full flex-col justify-end overflow-hidden bg-navy-deep pt-20 text-foreground">
      {thumbnailPath ? (
        ...
        <>
          <div
            aria-hidden
            className="absolute -top-[calc(16vw+120px)] left-[calc(12%-120px)] -z-20 size-[calc(50vw+240px)] opacity-25 glow-club"
          />
          <div
            aria-hidden
            className="absolute -right-[calc(12vw+100px)] top-[calc(33.333%-100px)] -z-20 size-[calc(38vw+200px)] opacity-15 glow-club"
          />
          <div
            aria-hidden
